  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(event)
        ...
        map("<leader>gd", require("fzf-lua").lsp_definitions, "[g]oto [d]definition")
        ...
        map("<leader>ws", require("fzf-lua").lsp_live_workspace_symbols, "[w]orkspace [s]symbols")
    ...
    vim.diagnostic.config({
      ...
      signs = {},
      -- To use icons instead of letters:
      -- signs = {
      --   text = {
    ...
    -- Extend LSP capabilities with capabilities provided by blink-cmp.
    ...
    local servers = {
      ...
      pyright = {},
      pylsp = {},
      -- rust_analyzer = {}, -- Use rustacean.nvim instead.
      rust_hdl = {}, -- vhdl
      svelte = {},
      tailwindcss = {},
      yamlls = {},
